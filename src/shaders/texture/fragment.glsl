...
Luma getLuma(void) {
    ...
    RGB rgb;
    rgb.n = textureAtOffset(vec2(0, 1));
    rgb.s = textureAtOffset(vec2(0, -1));
    rgb.e = textureAtOffset(vec2(1, 0));
    rgb.w = textureAtOffset(vec2(-1, 0));
    rgb.ne = textureAtOffset(vec2(1, 1));
    rgb.nw = textureAtOffset(vec2(-1, -1));
    rgb.se = textureAtOffset(vec2(1, -1));
    rgb.sw = textureAtOffset(vec2(-1, -1));
    rgb.m = textureAtOffset(vec2(0, 0));
